...
func Price(v int64) predicate.Game {
	return predicate.Game(func(s *sql.Selector) {
...
func PriceEQ(v int64) predicate.Game {
	return predicate.Game(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldPrice), v))
	})
}
...
func PriceNEQ(v int64) predicate.Game {
	return predicate.Game(func(s *sql.Selector) {
...
func PriceIn(vs ...int64) predicate.Game {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PriceNotIn(vs ...int64) predicate.Game {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PriceGT(v int64) predicate.Game {
	return predicate.Game(func(s *sql.Selector) {
...
func PriceGTE(v int64) predicate.Game {
	return predicate.Game(func(s *sql.Selector) {
...
func PriceLT(v int64) predicate.Game {
	return predicate.Game(func(s *sql.Selector) {
...
func PriceLTE(v int64) predicate.Game {
	return predicate.Game(func(s *sql.Selector) {
