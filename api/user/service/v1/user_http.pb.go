...
func RegisterUserHTTPServer(s *http.Server, srv UserHTTPServer) {
	r := s.Route("/")
	r.GET("/v1/catalog/health", _User_HealthCheck1_HTTP_Handler(srv))
}
...
func _User_HealthCheck1_HTTP_Handler(srv UserHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/user.service.v1.User/HealthCheck")
...
func (c *UserHTTPClientImpl) HealthCheck(ctx context.Context, in *HealthReq, opts ...http.CallOption) (*HealthReply, error) {
	...
	opts = append(opts, http.Operation("/user.service.v1.User/HealthCheck"))
