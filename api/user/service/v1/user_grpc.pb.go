...
func (c *userClient) HealthCheck(ctx context.Context, in *HealthReq, opts ...grpc.CallOption) (*HealthReply, error) {
	out := new(HealthReply)
	err := c.cc.Invoke(ctx, "/user.service.v1.User/HealthCheck", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServer) HealthCheck(context.Context, *HealthReq) (*HealthReply, error) {
...
func _User_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.service.v1.User/HealthCheck",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).HealthCheck(ctx, req.(*HealthReq))
	}
	return interceptor(ctx, in, info, handler)
}
