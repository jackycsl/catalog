...
type CatalogJobClient interface {
	ConsumerJob(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *catalogJobClient) ConsumerJob(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/catalog.job.v1.CatalogJob/ConsumerJob", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CatalogJobServer interface {
	ConsumerJob(context.Context, *emptypb.Empty) (*emptypb.Empty, error)
...
func (UnimplementedCatalogJobServer) ConsumerJob(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ConsumerJob not implemented")
}
...
func _CatalogJob_ConsumerJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CatalogJobServer).ConsumerJob(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/catalog.job.v1.CatalogJob/ConsumerJob",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CatalogJobServer).ConsumerJob(ctx, req.(*emptypb.Empty))
	}
...
var CatalogJob_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ConsumerJob",
			Handler:    _CatalogJob_ConsumerJob_Handler,
		},
	},
