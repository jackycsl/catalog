...
func NewGRPCServer(c *conf.Server, greeter *service.ShopAdmin, tp *tracesdk.TracerProvider, logger log.Logger) *grpc.Server {
	...
	v1.RegisterShopAdminServer(srv, greeter)
	return srv
}
